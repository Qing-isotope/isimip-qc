        ...
        for name in ['_FillValue', 'missing_value']:
            try:
                ...
                if name == 'missing_value':
                    file.warn(
                        '"%s" attribute for variable "%s" is missing. Should be set to 1e+20.',
                    ...
                    file.error('"%s" attribute for variable "%s" is missing. Should be set'
                               ' to 1e+20 and must be set when variable is created.',
